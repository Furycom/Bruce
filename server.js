...
const screensaverControlRoutes = require("./routes/screensaver-control");
const screensaverStatusRoutes = require("./routes/screensaver-status");
const screensaverStatsRoutes = require("./routes/screensaver-stats");
const screensaverRhythmRoutes = require("./routes/screensaver-rhythm");
const crossseedRoutes = require("./routes/crossseed");
...
app.use(screensaverControlRoutes);
app.use(screensaverStatusRoutes);
app.use(screensaverStatsRoutes);
app.use(screensaverRhythmRoutes);
app.use(crossseedRoutes);
